...
function App() {
  ...
  // Moved these state declarations and function INSIDE the App component
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <button 
                  onClick={() => smoothScroll('beranda')}
                  className="text-gray-900 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 hover:scale-105"
                >
                  Beranda
                </button>
                <button 
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            <div className="lg:col-span-6 animate-slide-in-left">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 animate-fade-in-up animation-delay-400">
                ...
                <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg font-semibold hover:border-blue-600 hover:text-blue-600 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                  Lihat Portfolio
                </button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              {/* Ensure the onSubmit handler is correctly passed to the form */}
              <form className="space-y-4" onSubmit={handleKirimPesan}>
                <div className="animate-fade-in animation-delay-100">
                  <label className="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap</label>
                  <input 
                    type="text"
                    value={nama} // Ensure value and onChange are correctly bound
                ...
                <div className="animate-fade-in animation-delay-200">
                  ...
                  <input 
                    type="email"
                    value={email} // Ensure value and onChange are correctly bound
                ...
                <div className="animate-fade-in animation-delay-300">
                  ...
                  <input 
                    type="text"
                    value={perusahaan} // Ensure value and onChange are correctly bound
                ...
                <div className="animate-fade-in animation-delay-400">
                  ...
                  <textarea 
                    rows={4}
                    value={pesan} // Ensure value and onChange are correctly bound
                    onChange={e => setPesan(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all duration-300 hover:shadow-md"
                    placeholder="Ceritakan kebutuhan teknologi Anda..."
                  ></textarea>
                </div>
                <button type="submit" className="w-full bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-fade-in animation-delay-500">
                  Kirim Pesan
                </button>
              </form>
            </div>
      ...
      <footer className="bg-black py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="mt-4 md:mt-0 text-gray-400 text-sm animate-fade-in animation-delay-200">
